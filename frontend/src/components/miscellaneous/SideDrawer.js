    ...
    <React.Fragment>
      ...
      >
         <Tooltip label="Search Users to chat" hasArrow placement="bottom-end">
          <Button variant="ghost" bg ='yellow.700' onClick={onOpen} color="white"
            _hover={{ background: "yellow.800", color:"yellow.400" }} _active={{ background: "green.800", color:"yellow.400" }}>
        ...
        <Text fontSize="3xl" fontFamily="Work sans bold" fontWeight='bold' color="orange.700" >
          Tak Tik
        </Text>
        ...
        <div>
          <Menu>
            <MenuButton p={1}>
              <NotificationBadge
                ...
                effect={Effect.SCALE}
              />
              <BellIcon fontSize="2xl" m={1} color="yellow.700"/>
            </MenuButton>
            <MenuList pl={2}>
          ...
          <Menu>
            <MenuButton as={Button} bg="yellow.700"  rightIcon={<ChevronDownIcon/>}  
              _hover={{background: "green.800", color:"orange.400"}} _active={{background: "green.800", color:"orange.400"}}>
